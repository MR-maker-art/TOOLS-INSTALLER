...
echo -b "AUTHOR    : MR-MAKER-ART $green " |lolcat
...
sleep 1
echo -b $green"[#]> MR-MAKER-ART" |lolcat

echo -b $green"[#]> See you Again MY FRIENDS :)..." |lolcat
figlet MR-MAKER-ART | lolcat
sleep 1
exit
}
...
00) echo "AUTHOR: MR-MAKER-ART" | lolcat
echo "NO SYSTEM IS SAFE" | lolcat
echo "TE4M THE DRAGON GLORY" | lolcat
